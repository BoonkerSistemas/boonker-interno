...
@Component({
    selector: 'addInventarioFilter',
    templateUrl: './addInventarioFilter.component.html',
    styleUrls: ['./addInventarioFilter.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AddInventarioFilterComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        public dialogRef1: MatDialogRef<AddInventarioFilterComponent>,
