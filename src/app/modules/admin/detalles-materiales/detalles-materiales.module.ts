...
import { detallesMaterialesRoutes } from './detalles-materiales.routing';
...
@NgModule({
    declarations: [
        DetallesMaterialesListaComponent,
        DetallesMaterialesComponent,
    ],
    imports: [
        RouterModule.forChild(detallesMaterialesRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
...
export class DetallesMaterialesModule {}
