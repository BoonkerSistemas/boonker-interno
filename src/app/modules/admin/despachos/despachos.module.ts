...
import {despachosRoutes} from 'app/modules/admin/despachos/despachos.routing';
import {DespachosListaComponent} from 'app/modules/admin/despachos/lista/lista.component';
...
@NgModule({
    declarations: [
        DespachosListaComponent,
        DespachosDetallesComponent
    ],
    imports: [
        RouterModule.forChild(despachosRoutes),
        MatButtonModule,
        MatCheckboxModule,
        MatFormFieldModule,
        MatIconModule,
