...
@Component({
    ...
    templateUrl: './detallesGenerales.component.html',
    styleUrls: ['./detallesGenerales.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: true
})
export class DetallesGeneralesComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<DetallesGeneralesComponent>,
