...
@Component({
    ...
    templateUrl: './crearIngreso.component.html',
    styleUrls: ['./crearIngreso.component.scss'],
...
export class CrearIngresoComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        public dialogRef1: MatDialogRef<CrearIngresoComponent>,
    ...
    upload(): void {
        ...
        if (this.selectedFiles) {
            ...
            if (file) {
                ...
                this.uploadService
                    .upload(this.currentFile, this.name)
                    .subscribe({
                        next: (event: any) => {
