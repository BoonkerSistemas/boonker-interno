...
export class CommentsService {
  private nombreModelo = "comments-new";
  ...
  findActivas(): Observable<any[]> {
    return this.httpClientService.get<any[]>(
        environment.api_url + this.nombreModelo +'/type/true'
    );
  }

  findInactivas(): Observable<any[]> {
    return this.httpClientService.get<any[]>(
        environment.api_url + this.nombreModelo +'/type/false'
    );
  }
