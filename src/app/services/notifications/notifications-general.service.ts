...
export class NotificationsGeneralService {
    ...
    private nombreModelo = 'notification';
    ...
    findAllNotification(type): Observable<any[]> {

        return this.httpClientService.get<any[]>(environment.api_url + this.nombreModelo + `/type/${type}`);
    }
